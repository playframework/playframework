...
public class Constraints {
  ...
  public static class ValidationPayload {
    ...
    /**
     * @deprecated Deprecated as of 2.7.0. Use {@link #ValidationPayload(Lang, Messages, TypedMap,
     *     Config)} instead.
     */
    @Deprecated
    public ValidationPayload(
    ...
    /**
     * @return if validation happens during a Http Request the args map of that request, otherwise
     *     null
