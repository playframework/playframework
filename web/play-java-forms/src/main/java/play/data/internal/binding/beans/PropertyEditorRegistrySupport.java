...
import play.data.internal.binding.beans.propertyeditors.ByteArrayPropertyEditor;
import play.data.internal.binding.beans.propertyeditors.CharArrayPropertyEditor;
import play.data.internal.binding.beans.propertyeditors.CharacterEditor;
import play.data.internal.binding.beans.propertyeditors.CharsetEditor;
import play.data.internal.binding.beans.propertyeditors.ClassArrayEditor;
import play.data.internal.binding.beans.propertyeditors.ClassEditor;
import play.data.internal.binding.beans.propertyeditors.CurrencyEditor;
import play.data.internal.binding.beans.propertyeditors.CustomBooleanEditor;
import play.data.internal.binding.beans.propertyeditors.CustomCollectionEditor;
import play.data.internal.binding.beans.propertyeditors.CustomMapEditor;
import play.data.internal.binding.beans.propertyeditors.CustomNumberEditor;
import play.data.internal.binding.beans.propertyeditors.FileEditor;
import play.data.internal.binding.beans.propertyeditors.InputSourceEditor;
import play.data.internal.binding.beans.propertyeditors.InputStreamEditor;
import play.data.internal.binding.beans.propertyeditors.LocaleEditor;
import play.data.internal.binding.beans.propertyeditors.PathEditor;
import play.data.internal.binding.beans.propertyeditors.PatternEditor;
import play.data.internal.binding.beans.propertyeditors.PropertiesEditor;
import play.data.internal.binding.beans.propertyeditors.ReaderEditor;
import play.data.internal.binding.beans.propertyeditors.StringArrayPropertyEditor;
import play.data.internal.binding.beans.propertyeditors.TimeZoneEditor;
import play.data.internal.binding.beans.propertyeditors.URIEditor;
import play.data.internal.binding.beans.propertyeditors.URLEditor;
import play.data.internal.binding.beans.propertyeditors.UUIDEditor;
import play.data.internal.binding.beans.propertyeditors.ZoneIdEditor;
import play.data.internal.binding.core.convert.ConversionService;
import play.data.internal.binding.core.io.Resource;
import play.data.internal.binding.core.io.support.ResourceArrayPropertyEditor;
...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	 ...
	 * such as {@link play.data.internal.binding.beans.propertyeditors.StringArrayPropertyEditor}.
