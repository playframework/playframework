...
public class NamedCaffeineCacheSpec {
  ...
  public void getAll_shouldReturnAllValuesWithTheGivenKeys() throws Exception {
      ...
      CompletableFuture<Map<String, String>> futureResult = cache.getAll(
  ...
  public void getAll_shouldCreateTheMissingValuesAndReturnAllWithTheGivenKeys() throws Exception {
      ...
      cache.put(key1, CompletableFuture.completedFuture(value1));
      Set<String> keys = new HashSet<>(Arrays.asList(key1, key2));
      HashMap<String, String> missingValuesMap = new HashMap<String, String>() {{
          put(key2, value2);
      }};
  ...
  public void getAll_shouldNotReplaceAlreadyExistingValues() throws Exception {
      ...
      HashMap<String, String> missingValuesMap = new HashMap<String, String>() {{
          put(key2, value2);
          put(key1, "value3"); // "value1" should not be replaced with "value3"
      }};
  ...
  public void getAll_shouldReturnFailedFutureIfMappingFunctionIsCompletedExceptionally() throws Exception {
      ...
      CompletableFuture resultFuture = cache.getAll(new HashSet<>(Arrays.asList("key1")), (missingKeys, executor) -> future);
