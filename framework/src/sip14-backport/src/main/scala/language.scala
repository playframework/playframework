...
object language {
   ...
   */
  implicit lazy val dynamics: dynamics = null
   ...
   */
  implicit lazy val postfixOps: postfixOps = null
   ...
   */
  implicit lazy val reflectiveCalls: reflectiveCalls = null
   ...
   */
  implicit lazy val implicitConversions: implicitConversions = null
   ...
   */
  implicit lazy val higherKinds: higherKinds = null
   ...
   */
  implicit lazy val existentials: existentials = null
  ...
  object experimental {
     ...
     */
    implicit lazy val macros: macros = null
  }
}
