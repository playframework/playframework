...
import scala.Option;
import scala.Some;
import play.core.utils.DevNullPlayInstrumentationFactory$;
...
public class TestServer extends play.api.test.TestServer {
    ...
    public TestServer(int port, FakeApplication application) {
        super(port, application.getWrappedApplication(), (Option) None$.MODULE$, DevNullPlayInstrumentationFactory$.MODULE$);
    }
    ...
    public TestServer(int port, FakeApplication application, int sslPort) {
        super(port, application.getWrappedApplication(), new Some(sslPort), DevNullPlayInstrumentationFactory$.MODULE$);
    }
