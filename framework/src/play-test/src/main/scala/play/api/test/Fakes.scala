 ...
 */
case class FakeRequest[A](method: String, uri: String, headers: FakeHeaders, body: A, remoteAddress: String = "127.0.0.1", version: String = "HTTP/1.1", id: Long = 666, tags: Map[String, String] = Map.empty[String, String], isHttps: Boolean = false) extends Request[A] {
  ...
  private def _copy[B](
    ...
    new FakeRequest[B](
      method, uri, headers, body, remoteAddress, version, id, tags, isHttps
    )
  }
