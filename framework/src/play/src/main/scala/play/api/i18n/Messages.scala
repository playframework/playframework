...
object Messages {
   ...
   *     Ok(Messages("MyMessages")).as(JAVASCRIPT)
   *   }
   * }}}
   * 
   ...
   * }}}
   * 
   * Providing you have the following message in your conf/messages file:
   * {{{
   * greeting=Hello %s!
   * }}}
   * 
   ...
   */
  def javascriptMessages(name: String = "Messages")(implicit app: Application, lang: Lang): String = {
