...
object Crypto {
   ...
   *
   * @deprecated This method is insecure and will be removed in future versions.
   * @param value The String to encrypt.
   * @return An hexadecimal encrypted string.
   */
  @Deprecated("2.4.4", "This method is insecure and will be removed in future versions.")
