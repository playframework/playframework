...
object SecurityHeadersFilter {
  val X_FRAME_OPTIONS_HEADER = HeaderNames.X_FRAME_OPTIONS_HEADER
  val X_XSS_PROTECTION_HEADER = HeaderNames.X_XSS_PROTECTION_HEADER
  val X_CONTENT_TYPE_OPTIONS_HEADER = HeaderNames.X_CONTENT_TYPE_OPTIONS_HEADER
  val X_PERMITTED_CROSS_DOMAIN_POLICIES_HEADER = HeaderNames.X_PERMITTED_CROSS_DOMAIN_POLICIES_HEADER
  val CONTENT_SECURITY_POLICY_HEADER = HeaderNames.CONTENT_SECURITY_POLICY_HEADER
