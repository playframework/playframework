...
object Dependencies {
  ...
  val sbtDependencies = Seq(
    ...
    "com.typesafe.sbteclipse" % "sbteclipse-plugin" % "2.2.0-SNAPSHOT" extra("sbtVersion" -> BuildSettings.buildSbtVersion, "scalaVersion" -> BuildSettings.buildScalaBinaryVersionForSbt),
    "com.github.mpeltonen" % "sbt-idea" % "1.5.0-SNAPSHOT" extra("sbtVersion" -> BuildSettings.buildSbtVersion, "scalaVersion" -> BuildSettings.buildScalaBinaryVersionForSbt),
