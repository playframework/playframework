...
val sbtHeader          = "5.8.0"
val scalafmt           = "2.4.6"
val sbtTwirl: String   = sys.props.getOrElse("twirl.version", "2.1.0-M2") // sync with documentation/project/plugins.sbt
...
addSbtPlugin("nl.gn0s1s" % "sbt-pekko-version-check" % "0.0.6")
