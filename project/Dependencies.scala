...
object Dependencies {
  ...
  val pekkoHttpVersion     = sys.props.getOrElse("pekko.http.version", "2.0.0-M1+309-7d3ae9a3-SNAPSHOT")
  ...
  val mockitoAll = "org.mockito"      % "mockito-core" % "5.24.0"
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate.orm"   % "hibernate-core"          % "7.4.10.Final" % "test",
    "org.hibernate.orm"   % "hibernate-scan-jandex"   % "7.4.10.Final" % "test"
  )
  ...
  val playWsStandaloneVersion = "3.1.0-M14+18-e10c553c-SNAPSHOT"
  val playWsDeps              = Seq(
