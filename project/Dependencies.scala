...
object Dependencies {
  ...
  val akkaVersion: String = sys.props.getOrElse("akka.version", "2.6.0-RC1")
  ...
  val mockitoAll = "org.mockito"              % "mockito-core" % "3.1.0"
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate"                   % "hibernate-core"        % "5.4.7.Final" % "test"
  )
  ...
  val springFrameworkVersion = "5.2.0.RELEASE"
  ...
  val playWsStandaloneVersion = "2.1.0-M7"
  val playWsDeps = Seq(
