...
object Dependencies {
  val pekkoVersion: String = sys.props.getOrElse("pekko.version", "1.3.0")
  ...
  val mockitoAll = "org.mockito"      % "mockito-core" % "5.20.0"
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate.orm"   % "hibernate-core"          % "7.1.11.Final" % "test",
    "org.hibernate.orm"   % "hibernate-scan-jandex"   % "7.1.11.Final" % "test"
  )
