...
object Dependencies {
  val pekkoVersion: String = sys.props.getOrElse("pekko.version", "1.5.0")
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate.orm"   % "hibernate-core"          % "7.2.10.Final" % "test",
    "org.hibernate.orm"   % "hibernate-scan-jandex"   % "7.2.10.Final" % "test"
  )
  ...
  def sbtDependencies(sbtVersion: String, scalaVersion: String) = {
    ...
    Seq(
      ...
      sbtDep("com.github.sbt"          % "sbt-web"             % "1.6.0-M3"),
      sbtDep("com.github.sbt"          % "sbt-js-engine"       % "1.4.0-M3"),
      logback % Test
