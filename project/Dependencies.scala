...
object Dependencies {
  val pekkoVersion: String = sys.props.getOrElse("pekko.version", "2.0.0-M2")
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate.orm"   % "hibernate-core"          % "7.3.5.Final" % "test",
    "org.hibernate.orm"   % "hibernate-scan-jandex"   % "7.3.5.Final" % "test"
  )
