...
object Dependencies {
  val pekkoVersion: String = sys.props.getOrElse("pekko.version", "1.1.2")
  val pekkoHttpVersion     = sys.props.getOrElse("pekko.http.version", "1.1.0")
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate"       % "hibernate-core"          % "6.6.3.Final" % "test"
  )
  ...
  val springFrameworkVersion = "6.1.15"
