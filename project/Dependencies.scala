...
object Dependencies {
  ...
  val pekkoHttpVersion     = sys.props.getOrElse("pekko.http.version", "2.0.0-M1+246-dfd5b18c-SNAPSHOT")
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate.orm"   % "hibernate-core"          % "7.4.6.Final" % "test",
    "org.hibernate.orm"   % "hibernate-scan-jandex"   % "7.4.6.Final" % "test"
  )
