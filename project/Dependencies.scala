...
object Dependencies {
  ...
  val playWsStandaloneVersion = "2.1.10+1-13e48d3c-SNAPSHOT"
  val playWsDeps = Seq(
 ...
 *
 * Make sure Akka-HTTP has 2.12 as the FIRST version (or that scalaVersion :=
"2.12.17", otherwise it won't find the artifact
