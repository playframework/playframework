...
object BuildSettings {
  ...
  def playRuntimeSettings: Seq[Setting[?]] = Def.settings(
    ...
    mimaBinaryIssueFilters ++= Seq(
      ...
      ProblemFilters.exclude[DirectMissingMethodProblem]("play.mvc.Result.discardingCookie"),
      ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.mvc.Result.discardingCookie"),
