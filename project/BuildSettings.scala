...
object BuildSettings {
  ...
  def playRuntimeSettings: Seq[Setting[_]] = Def.settings(
    ...
    mimaBinaryIssueFilters ++= {
      def excludeSymbols[P <: ProblemRef](name: String, symbolFilter: String => Boolean)(
          implicit problemTag: ClassTag[P]
      ): ProblemFilter = {
        { problem: Problem =>
      ...
      // defined in play.api.http.MimeTypes
      val mimeTypesConstants = Set(
        "TEXT",
        "HTML",
        "JSON",
        "XML",
      ...
      // defined in play.api.http.ContentTypes
      val contentTypesConstants = Set( /*"CACHE_MANIFEST", */ "JSON", "FORM", "BINARY")
      // defined in play.api.http.HttpProtocol
      val httpProtocolConstants = Set("HTTP_1_0", "HTTP_1_1", "CHUNKED")
      // defined in play.api.http.HeaderNames
      val headerNamesConstants = Set(
        "ACCEPT",
        "ACCEPT_CHARSET",
        "ACCEPT_ENCODING",
        "ACCEPT_LANGUAGE",
      ...
      // defined in play.api.http.Status
      val statusConstants = Set(
        "CONTINUE",
        "SWITCHING_PROTOCOLS",
        "OK",
        "CREATED",
      ...
      // defined in play.api.http.HttpVerbs
      val httpVerbsConstants = Set("GET", "POST", "PUT", "PATCH", "DELETE", "HEAD", "OPTIONS")

      Seq(
        // Make trait constant variables final
        excludeSymbols[DirectMissingMethodProblem]("play.api.http.MimeTypes", mimeTypesConstants),
        excludeSymbols[DirectMissingMethodProblem]("play.api.http.ContentTypes", contentTypesConstants),
        excludeSymbols[DirectMissingMethodProblem]("play.api.http.HttpProtocol", httpProtocolConstants),
        excludeSymbols[DirectMissingMethodProblem]("play.api.http.HeaderNames", headerNamesConstants),
        excludeSymbols[DirectMissingMethodProblem]("play.api.http.Status", statusConstants),
        excludeSymbols[DirectMissingMethodProblem]("play.api.http.HttpVerbs", httpVerbsConstants),
        // Following classes extend the above traits
        excludeSymbols[DirectMissingMethodProblem](
          "controllers.Default",
          contentTypesConstants ++ headerNamesConstants ++ statusConstants ++ httpProtocolConstants
        ),
        excludeSymbols[DirectMissingMethodProblem](
        ...
        excludeSymbols[DirectMissingMethodProblem](
          ...
          httpProtocolConstants ++ mimeTypesConstants ++ statusConstants ++ headerNamesConstants ++ httpVerbsConstants
        ),
        // CACHE_MANIFEST is final now as well
        excludeSymbols[FinalMethodProblem]("controllers.Default", Set("CACHE_MANIFEST")),
        excludeSymbols[FinalMethodProblem]("controllers.ExternalAssets", Set("CACHE_MANIFEST")),
        excludeSymbols[FinalMethodProblem]("controllers.AssetsBuilder", Set("CACHE_MANIFEST")),
        excludeSymbols[FinalMethodProblem]("play.api.mvc.AbstractController", Set("CACHE_MANIFEST")),
        excludeSymbols[FinalMethodProblem]("play.api.mvc.MessagesAbstractController", Set("CACHE_MANIFEST")),
        ...
        // Remove deprecated
        ProblemFilters
          .exclude[DirectMissingMethodProblem]("play.data.validation.Constraints#ValidationPayload.getArgs"),
        ...
        ProblemFilters
          .exclude[IncompatibleResultTypeProblem]("play.api.libs.Files#TemporaryFile.atomicMoveWithFallback"),
