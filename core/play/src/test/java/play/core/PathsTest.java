...
public final class PathsTest {
  ...
  public void testRelative1() throws Throwable {
    ...
    assertEquals(
        "Relative path should return sibling path without common root",
        "one",
  ...
  public void testRelative2() throws Throwable {
    ...
    assertEquals(
        "Relative should return sibling path without common root",
        "two/asset.js",
        Paths.relative(startPath, targetPath));
  }
  ...
  public void testRelative3() throws Throwable {
    ...
    assertEquals(
        "Relative path should include one parent directory and last common element of target route with no trailing /",
        "../one",
        Paths.relative(startPath, targetPath));
  }
  ...
  public void testRelative4() throws Throwable {
    ...
    assertEquals(
        "Relative path should include one parent directory and no last common element",
        "../",
        Paths.relative(startPath, targetPath));
  }
  ...
  public void testRelative5() throws Throwable {
    ...
    assertEquals(
        "Relative path should include two parent directory",
        "../one-b/two-b",
        Paths.relative(startPath, targetPath));
  }

  /**
   * Current Path: /one/two/three Target Path: /one-b/two-b/asset.js Relative Path:
   * ../../one-b/two-b
   */
  @Test
  public void testRelative6() throws Throwable {
    ...
    assertEquals(
        "Relative path should no common root segments and include three parent directories",
        "../../one-b/two-b/asset.js",
        Paths.relative(startPath, targetPath));
  }

  /**
   * Current Path: /one/two/three/four Target Path: /one/two/three-b/four-b/asset.js Relative Path:
  ...
  public void testRelative7() throws Throwable {
    ...
    assertEquals(
        "Relative path should have two common root segments and include two parent directories",
        "../three-b/four-b/asset.js",
        Paths.relative(startPath, targetPath));
  }
  ...
  public void testRelative8() throws Throwable {
    ...
    assertEquals(
        "Relative path should retain trailing forward slash if it exists in Call",
        "two-c/",
        Paths.relative(startPath, targetPath));
  }
  ...
  public void testRelative9() throws Throwable {
    ...
    assertEquals("Relative path return current dir", ".", Paths.relative(startPath, targetPath));
  }

  /**
   * Current Path: /one/two//three/../three-b/./four/ Canonical Current Path: /one/two/three-b/four/
   * Target Path: /one-b//two-b/./ Canonical Target Path: /one-b/two-b/ Relative Path:
   * ../../../../one-b/two-b/
   */
  @Test
  public void testRelative10() throws Throwable {
    ...
    assertEquals(
        "Relative path return current dir",
        "../../../../one-b/two-b/",
        Paths.relative(startPath, targetPath));
  }
  ...
  public void testCanonical1() throws Throwable {
    ...
    assertEquals(
        "Canonical path return handles parent directories",
        "/one/two-b/three",
  ...
  public void testCanonical2() throws Throwable {
    ...
    assertEquals(
        "Canonical path handles current directories",
        "/one/two/three",
        Paths.canonical(targetPath));
  }
  ...
  public void testCanonical3() throws Throwable {
    ...
    assertEquals(
        "Canonical path handles multiple directory separators",
        "/one/two/three",
        Paths.canonical(targetPath));
  }
}
