...
public final class CallTest {
  ...
  public void testHttpAbsoluteURL1() throws Throwable {
    ...
    assertEquals(
        "Absolute URL should have HTTP scheme",
  ...
  public void testHttpsAbsoluteURL1() throws Throwable {
    ...
    assertEquals(
        "Absolute URL should have HTTPS scheme",
  ...
  public void testWebSocketURL1() throws Throwable {
    ...
    assertEquals(
        "WebSocket URL should have HTTP scheme",
  ...
  public void testSecureWebSocketURL1() throws Throwable {
    ...
    assertEquals(
        "WebSocket URL should have HTTPS scheme",
  ...
  public void testRelative1() throws Throwable {
    ...
    assertEquals("Relative path takes start path from Request", "two-b", call.relativeTo(req));
  }
  ...
  public void testRelative2() throws Throwable {
    ...
    assertEquals("Relative path takes start path as String", "two-b", call.relativeTo(startPath));
  }
  ...
  public void testRelative3() throws Throwable {
    ...
    assertEquals("Relative path includes fragment", "two-b#foo", call.relativeTo(req));
  }
