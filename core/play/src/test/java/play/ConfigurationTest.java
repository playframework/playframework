...
public class ConfigurationTest {
  ...
  public void beAccessibleAsAMap() {
    assertThat(exampleConfig().asMap())
        .hasSize(2)
        .includes(
  ...
  public void makesUnderlyingAccessible() {
    Config underlying = ConfigFactory.parseMap(ImmutableMap.of("foo.bar1", "value1"));
  ...
  public Configuration exampleConfig() {
    return new Configuration(
        ImmutableMap.of("foo.bar1", "value1", "foo.bar2", "value2", "blah", "value3"));
  }
}
