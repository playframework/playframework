...
trait HeaderNames {
  ...
  final val CONTENT_SECURITY_POLICY_REPORT_ONLY    = "Content-Security-Policy-Report-Only"
  final val X_CONTENT_SECURITY_POLICY_NONCE_HEADER = "X-Content-Security-Policy-Nonce"
}
