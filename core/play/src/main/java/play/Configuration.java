...
public class Configuration {
  ...
  /**
   * Retrieves a sub-configuration, which is a configuration instance containing all keys that start
  ...
  /**
   * Returns the config as a set of full paths to config values. This is different to {@link
   * #asMap()} in that it returns {@link com.typesafe.config.ConfigValue} objects, and keys are
   * recursively expanded to be pull path keys.
   *
  ...
  public List<Map<String, Object>> getObjectList(
      String key, List<Map<String, Object>> defaultList) {
