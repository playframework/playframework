...
public abstract class Controller extends Results implements Status, HeaderNames {
   ...
   * @deprecated Deprecated as of 2.7.0. Use {@link MessagesApi#setLang(Result, Lang)} or {@link
   ...
   *
   * @deprecated Deprecated as of 2.7.0. Use {@link MessagesApi#clearLang(Result)} or {@link
   *     Result#withoutLang(MessagesApi)}.
   */
  @Deprecated
   ...
   * @return the value corresponding to <code>key</code> from the flash scope, or null if there was
   *     none
   * @deprecated Deprecated as of 2.7.0. Use {@link Result} instead.
   */
  @Deprecated
