...
public abstract class AbstractRoutingDslTest {
  ...
  public void noParameters() {
    Router router =
        router(
            routingDsl -> routingDsl.GET("/hello/world").routeTo(() -> ok("Hello world")).build());
  ...
  public void oneParameter() {
    Router router =
        router(routingDsl -> routingDsl.GET("/hello/:to").routeTo(to -> ok("Hello " + to)).build());
    ...
    Router router =
        router(
            routingDsl ->
                routingDsl
                    .GET("/:say/:to/:extra")
                    .routeTo((say, to, extra) -> ok(say + " " + to + extra))
                    .build());
    ...
    Router router =
        router(
            routingDsl ->
                routingDsl
                    .GET("/hello/world")
                    .routeAsync(() -> completedFuture(ok("Hello world")))
                    .build());
    ...
    Router router =
        router(
            routingDsl ->
                routingDsl
                    .GET("/hello/:to")
                    .routeAsync(to -> completedFuture(ok("Hello " + to)))
                    .build());
    ...
    Router router =
        router(
            routingDsl ->
                routingDsl
                    .GET("/:say/:to")
                    .routeAsync((say, to) -> completedFuture(ok(say + " " + to)))
                    .build());
  ...
  public void head() {
    Router router =
        router(
            routingDsl -> routingDsl.HEAD("/hello/world").routeTo(() -> ok("Hello world")).build());
  ...
  public void post() {
    Router router =
        router(
            routingDsl -> routingDsl.POST("/hello/world").routeTo(() -> ok("Hello world")).build());
  ...
  public void put() {
    Router router =
        router(
            routingDsl -> routingDsl.PUT("/hello/world").routeTo(() -> ok("Hello world")).build());
  ...
  public void starMatcher() {
    Router router =
        router(
            routingDsl -> routingDsl.GET("/hello/*to").routeTo((to) -> ok("Hello " + to)).build());
        ...
        router(
            routingDsl ->
                routingDsl
                    ...
                    .routeTo(() -> ok("foo bar"))
                    .POST("/hello/:to")
                    .routeTo((to) -> ok("Post " + to))
                    .GET("/*path")
                    .routeTo((path) -> ok("Path " + path))
                    .build());
    ...
    Router router =
        router(
            routingDsl ->
                routingDsl
                    .GET("/simple/:to")
                    .routeTo((to) -> ok("Simple " + to))
                    .GET("/path/*to")
                    .routeTo((to) -> ok("Path " + to))
                    .GET("/regex/$to<.*>")
                    .routeTo((to) -> ok("Regex " + to))
                    .build());
  ...
  public void bindError() {
    Router router =
        router(routingDsl -> routingDsl.GET("/:a").routeTo((Integer a) -> ok("int " + a)).build());
