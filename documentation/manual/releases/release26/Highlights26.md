...
It is now possible to define the naming strategy used to map JSON fields to class properties. Notice this only customizes the JSON mappings generated by play-json macros.
