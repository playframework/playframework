...
* [Typical `.gitignore` file](Typical-`.gitignore`-file)
* [Default SBT layout](Default-SBT-layout)
...
* [The `conf/` directory](#The-`conf/`-directory)
* [The `lib/` directory](#The-`lib/`-directory)
* [The `build.sbt` file](#The=`build.sbt`-file)
