...
By default Ebean will use transactions. However, transactions will be created before and commited or rollbacked after every single query, update, create or delete, as you can see here:
