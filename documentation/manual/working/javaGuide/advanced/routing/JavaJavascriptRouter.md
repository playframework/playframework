...
An embedded router can be generated using the ``@javascriptRouter`` directive inside a [[Twirl template|JavaTemplates]]. This is typically done inside the main decorating template.
