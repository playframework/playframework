...
Play provides an experimental module for integration with Akka Cluster Sharding Typed. To enable this module, add `javadslClusterSharding` in your build dependencies:

```scala
libraryDependencies += javadslClusterSharding
```
