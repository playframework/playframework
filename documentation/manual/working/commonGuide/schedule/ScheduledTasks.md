...
You can see the Akka documentation to see other possible uses of the scheduler. See the documentation for [`akka.actor.Scheduler` for Scala](http://doc.akka.io/api/akka/2.5/akka/actor/Scheduler.html) or [for Java](http://doc.akka.io/japi/akka/2.5/akka/actor/Scheduler.html).
