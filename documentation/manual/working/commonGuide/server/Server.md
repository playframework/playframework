...
Starting in 2.6.x, the default server backend is the Pekko HTTP server backend, based on the [Pekko-HTTP](https://pekko.apache.org/docs/pekko-http/2.0/) server.  Prior to 2.6.x, the server backend is Netty.
