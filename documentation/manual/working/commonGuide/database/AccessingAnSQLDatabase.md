...
1. Scala: going to [playframework/play-scala-anorm-example/](https://github.com/playframework/play-scala-anorm-example/) shows that the [CompanyRepository](https://github.com/playframework/play-scala-anorm-example/blob/2.8.x/app/models/CompanyRepository.scala) class takes a `DatabaseExecutionContext` that wraps all the database operations.
1. Java: going to [playframework/play-java-jpa-example](https://github.com/playframework/play-java-jpa-example/) shows that the [JPAPersonRepository](https://github.com/playframework/play-java-jpa-example/blob/2.8.x/app/models/JPAPersonRepository.java) class takes a `DatabaseExecutionContext` that wraps all the database operations.
