...
[Actor Typed API]: https://pekko.apache.org/docs/pekko/2.0/typed/actors.html
[fp-style]: https://pekko.apache.org/docs/pekko/2.0/typed/actors.html#functional-style
[oo-style]: https://pekko.apache.org/docs/pekko/2.0/typed/actors.html#object-oriented-style
...
When [interacting with actors from outside of another Actor](https://pekko.apache.org/docs/pekko/2.0/typed/interaction-patterns.html#request-response-with-ask-from-outside-an-actor), for example from a `Controller`, you need to use `AskPattern.ask` to send a message to the actor and get a response. The `AskPattern.ask` method requires a `pekko.actor.typed.Scheduler` that you can obtain via Dependency Injection.
