...
@[simple-pekko-http](code/ScalaAkkaEmbeddingPlay.scala)
...
@[config-pekko-http](code/ScalaAkkaEmbeddingPlay.scala)
...
@[components-pekko-http](code/ScalaAkkaEmbeddingPlay.scala)
...
@[stop-pekko-http](code/ScalaAkkaEmbeddingPlay.scala)
...
@[application-pekko-http](code/ScalaAkkaEmbeddingPlay.scala)
...
@[logger-pekko-http](code/ScalaAkkaEmbeddingPlay.scala)
