...
In some cases it is useful to convert a [Response](api/scala/play/api/libs/ws/WSResponse.html) to a [Result](api/scala/play/api/mvc/Result.html). This can easily done by adding the following conversion:
