...
You can process the response as a [JSON object](https://www.javadoc.io/doc/com.typesafe.play/play-json_2.13/2.10.2/play/api/libs/json/JsValue.html) by calling `response.json`.

@[scalaws-process-json](code/ScalaWSSpec.scala)

The JSON library has a [[useful feature|ScalaJsonCombinators]] that will map an implicit [`Reads[T]`](https://www.javadoc.io/doc/com.typesafe.play/play-json_2.13/2.10.2/play/api/libs/json/Reads.html) directly to a class:
