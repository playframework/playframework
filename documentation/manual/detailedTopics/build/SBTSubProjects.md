...
`myLibrary` has its own `build.sbt` file(note that a file in myLibrary/project/Build.scala will not be discovered), this is where it can declare its own settings, dependencies etc.
