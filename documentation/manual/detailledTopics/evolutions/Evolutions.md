...
# Evolutions and security

The evolutions plugin will, as shown above, show the sql to be run in the view with the upgrade button. Depending on your security requirements, this may be viewed as leaking security-sensitive information. If this is the case in your environment, the evolutions plugin should be switched off. Apply the evolutions script manually during a planned maintenance period instead.
